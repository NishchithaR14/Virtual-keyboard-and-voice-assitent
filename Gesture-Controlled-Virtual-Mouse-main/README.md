...
This is a final year Computer Science Engineering project demonstrating:
...
- Check `proton_logs.txt` for errors

**Gesture control not starting:**
- Ensure webcam is connected
- Check OpenCV installation
- Verify camera permissions

**Application paths not working:**
